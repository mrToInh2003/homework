...
public class DownloadServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request,
        ...
        }if (action.equals("downloadMP3")) {
            downloadMP3(request, response);
            return;  // Return immediately after downloading the file
        }
    ...
    private void downloadMP3(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String filePath = "musicStore\\sound\\" + fileName;
