...
<tr>
    <td>64 Corvair</td>
    <td><audio controls><source src="./musicStore/sound/${productCode}/corvair.mp3" type="audio/mpeg"></audio>
    <td><a href="?action=downloadMP3&fileName=pf01/corvair.mp3">star.mp3</a></td>
   
</tr>
<tr>
    <td>Whiskey Before Breakfast</td>
    <td><audio controls><source src="./musicStore/sound/${productCode}/whiskey.mp3" type="audio/mpeg"></audio>
