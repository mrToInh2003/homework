...
<tr>
    ...
    <td><audio controls><source src="./musicStore/sound/${productCode}/star.mp3" type="audio/mpeg"></audio>
    <td><a href="?action=downloadMP3&fileName=8601/star.mp3">star.mp3</a></td>
</tr>
<tr>
    <td>Don't Make No Difference</td>
    <td><audio controls><source src="./musicStore/sound/${productCode}/no_difference.mp3" type="audio/mpeg"></audio>
